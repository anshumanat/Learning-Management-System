...
exports.createCourse = async (req, res) => {
	try {
		...
		console.log('--- [createCourse] New course created ---')
		...
		console.log('--- [createCourse] Response sent ---')
	} catch (error) {
...
exports.editCourse = async (req, res) => {
  try {
    ...
    console.log("[editCourse] COURSE ID:", courseId);
    console.log("[editCourse] BODY:", req.body);
    console.log("[editCourse] FILES:", req.files);
    ...
    if (req.files && req.files.thumbnailImage) {
      console.log("[editCourse] thumbnail update");
    ...
    Object.keys(updates).forEach((key) => {
      if (key === "tag" && typeof updates[key] === "string") {
        course[key] = JSON.parse(updates[key]);
      } else if (key === "instructions" && typeof updates[key] === "string") {
        course[key] = JSON.parse(updates[key]);
...
//     try{
//         //agr ye itna pura scehma nahi hoga tab : Todo -> change the below statement incrementally
